...
#include "SecondTutorialSkillSM.h"
...
class SecondTutorialSkill
{
public:
	SecondTutorialSkill(std::string name );
	...
	void topic_callback_Function2(const std_msgs::msg::Bool::SharedPtr msg);
...
private:
	...
	std::string m_name;
	SecondTutorialSkillCondition m_stateMachine;
	...
	rclcpp::Subscription<std_msgs::msg::Bool>::SharedPtr m_subscription_Function2;
